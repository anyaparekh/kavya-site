...
type PickProps = { slug: string; cls: "a" | "b" | "c"; ratio: string; tag: string };
  ...
  return (
    <>
      ...
      <section className="hero" aria-label="Featured photo">
        <Header />
        <Photo src={IMAGES.hero} label="Hero photo: Aït Ben Haddou, people crossing the river" />
      ...
      <section className="picks" aria-label="Selected collections">
        <div className="picks-grid">
          ...
          <Pick slug="washington-state" cls="b" ratio="4/3" tag="Washington State" />
